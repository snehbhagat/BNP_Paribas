...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      icon: Users,
      description: 'Customer groups and behavior'
    },
    {
      name: 'Sales Forecasting',
      href: '/sales-forecasting',
      icon: TrendingUp,
      description: 'Revenue and sales predictions'
    },
    {
        ...
        <div className={`relative flex-1 flex flex-col max-w-xs w-full bg-white transition-transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">BNP Analytics</span>
            </div>
